let feherkepek = ["szuret_f.jpg","preseles.jpg","pres-szoloszuret.jpg","ulepites.jpg","bor-erjesztes.jpg","erleles.jpg",""]
let feherh2 = ["Szőlőszüret","Zúzás","Préselés","Ülepítés","Erjesztés", "Érlelés", "Szűrés és palackozás"]
let feherp = ["Általában zöld vagy sárga héjú szőlőt használnak.", "A zúzás során a szőlőszemeket enyhén összetörik, hogy a héjból és a húsból kiszabaduljon a must. A cél nem a teljes pépesítés, hanem a szemek feltárása a további feldolgozáshoz.","A zúzást követően a szőlőt kipréselik, hogy elválasszák a levet (mustot) a szilárd részeitől (héj, mag, szár). Fehérbor esetén a héjjal való érintkezést minimálisra csökkentik, ezért a préselés gyorsan, a kierjedés előtt történik meg.","A mustot hagyják leülepedni, hogy a zavaros részecskék eltávolíthatók legyenek.", " A tiszta mustot alacsony hőmérsékleten, rozsdamentes acéltartályokban erjesztik, így megőrzik a friss, gyümölcsös aromákat.", "Rövidebb ideig tart, gyakran tartályban, ritkábban hordóban.", "A bort leszürik, majd palackozzák."]
let rosekepek = ["szuret_r.jpg","szolopres.jpg","images.jpg","preseles2.jpg","must-erjedese.jpg",""]
...
let voroskepek = ["szuret.jpg","preseles.jpg","bor-erjesztese.jpg","comosz.jpg","preseles2.jpg","vorosb_erl.jpg",""]
